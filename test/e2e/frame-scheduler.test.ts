...
describe("C03 e2e", () => {
  ...
  it.todo(
    "T5.4: dragging the terminal edge continuously — every frame correct, none blank, no corruption — waits on C24 — the paint exists and C03 T4.9 asserts the width property against a fake terminal; a PTY needs a binary to drive, and `createTui` is not exported until the public API is",
  );
  it.todo(
