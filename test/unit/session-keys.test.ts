...
describe("C22 §3 step 11 — the effect table", () => {
  ...
  it("T1.4l (C09 I13): a constructed graph can render all nineteen kinds", async () => {
    ...
    expect(graph.blocks.kinds.length, "C09's sixteen and the three registered").toBe(19);
  });
