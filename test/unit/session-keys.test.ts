...
describe("C22 §3 step 11 — the effect table", () => {
  ...
  it("T1.4l (C09 I13): a constructed graph can render all twenty-three kinds", async () => {
    ...
    expect(graph.blocks.kinds.length, "C09's twenty and the three registered").toBe(23);
  });
