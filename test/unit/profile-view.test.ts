...
describe("C28 §3c — the profiler's view", () => {
  ...
  // **T1.109, T1.110 and T1.112 live in `profile-deck.test.ts`**, with the four
  // report fixtures they are about. They were written here when this file was
  // the only one that could build a report; a row over the whole deck at four
  // fixtures and two regions belongs with the fixtures, and T1.120 — the row
  // F1142 asked for — is beside them.
});
