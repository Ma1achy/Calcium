...
// `packages: "external"` leaves the runtime dependencies to the consumer's tree,
// which is what kept `prepareLaunch()`'s target resolvable at
// `node_modules/ink/build/ink.js` until Ink and that entry went (F1209, C24 I37
// retired) and is now simply what an external dependency means; a dynamic `import()` stays its own
...
//
// The entries are C24 §2's five, from the `tsc` tree, into `dist/bundle/`; the
