...
export const REFUSALS = Object.freeze([
  ...
  { id: "R25", where: "DEPENDENCIES.md § Not installed · a layout engine (nicbarker/clay)",
    premise: { absent: "clay", in: "package.json" },
    why: "the design is kept and attributed (C29 I17); the package is refused because it is C, its unit is a float against C29 I1's whole cells, and its arena, culling and measure-text cache are all owned elsewhere here. **Blind spot, and it is the whole of what matters**: this watches the package name, and the risk is the *port* drifting from upstream, which no grep can see — the version read is in the module header so a reader can go and look" },
