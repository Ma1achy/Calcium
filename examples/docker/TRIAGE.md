...
| **11** | [A gate that passes without checking](#11) | 75 | **15** | — | 9 closed · **7 open** — four about a rule's reach, and **F163 about a gate's *scope*: golden stops one layer below the painter** · **F173 is the group's own instrument, blind to 23% of what it counted** |
...
## 11 · A gate that passes without checking — **49: 24 closed, 25 open**
