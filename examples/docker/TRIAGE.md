...
| **7** | [An artefact describes the world rather than being checked against it](#7) | 20 | **14** | — | artefact discipline — **no code**, and F164 is the first found by an instrument's *population* step rather than by a reader |
