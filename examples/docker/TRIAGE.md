...
| **7** | [An artefact describes the world rather than being checked against it](#7) | 23 | **15** | — | artefact discipline — **no code**, and F164 is the first found by an instrument's *population* step rather than by a reader; **F210 is the first where the artefact is a component's own spec and the thing it contradicts is a shipped frame** |
