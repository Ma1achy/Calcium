...
| **8** | [Absence indistinguishable from failure](#8) | 17 | **5 open** (7 closed) | partly | real Calcium work · **7 of 10 fixed** — F151 is the class F35 closed in the half an app-side test cannot reach, and **F167 is the class arriving in a *value*: a validator agreeing twice about two different documents** |
...
| **11** | [A gate that passes without checking](#11) | 53 | **14** | — | 9 closed · **7 open** — four about a rule's reach, and **F163 about a gate's *scope*: golden stops one layer below the painter** · **F173 is the group's own instrument, blind to 23% of what it counted** |
...
## 8 · Absence indistinguishable from failure — **5 open, 6 closed**
...
## 11 · A gate that passes without checking — **30: 16 closed, 14 open**
