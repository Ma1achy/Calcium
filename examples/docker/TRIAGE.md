...
| **7** | [An artefact describes the world rather than being checked against it](#7) | 19 | **14** | — | artefact discipline — **no code**, and F164 is the first found by an instrument's *population* step rather than by a reader |
...
| **11** | [A gate that passes without checking](#11) | 41 | **13** | — | 9 closed · **7 open** — four about a rule's reach, and **F163 about a gate's *scope*: golden stops one layer below the painter** · **F173 is the group's own instrument, blind to 23% of what it counted** |
...
## 11 · A gate that passes without checking — **22: 13 closed, 9 open**
