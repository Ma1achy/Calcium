...
| **10** | [**A claim carried without a record**](#10) | 18 | **10** | — | **new at F80** · method — six findings disproved, and **F166 unblocked an entry while F168 found what the same row was silent about**; F184 is the first where the unrecorded claim was a *rule* rather than a fact, governing thirty forms from a parameter's doc comment |
...
## 10 · A claim carried without a record — **10: five findings disproved, four claims caught before anything was built on them, one rule that governed thirty forms** · new at F80
