...
// thirteen hundred. Ink is gone (F1209) and so is es-toolkit, so the hooks had
// nothing left to arm and the entry point is removed rather than kept as a call
// whose every branch is unreachable.
