...
export const manifest = {
  ...
  tools: [
    ...
    { name: "report", local: true, summary: "This framework, measured — C28's report as a document; `/profile` is the framework's live view", args: [{ name: "pane", type: "string", required: false, summary: "overview · frame · distribution · memory" }], flags: [] },
