...
export const manifest = {
  ...
  tools: [
    ...
    { name: "report", local: true, summary: "This framework, measured — C28's report as a document; `/profile` is the framework's live view", args: [{ name: "card", type: "string", required: false, summary: "one of CARDS — verdict · vitals · where-the-frame-went · memory · leaks · caches · …" }], flags: [] },
