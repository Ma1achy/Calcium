...
21. **A bar or spark cell draws its glyph, inside the width the column planned** (I23). C04 obliges the mark and this is where it is spent; the series takes what the mark leaves, and the mark is dropped only where it does not fit (→ C04 I6, C12 I25, FINDINGS F1104).
