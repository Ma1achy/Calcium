...
| 2a | menu opened by typing (C19 I20) | **the prompt's** — the menu takes no keys until `Tab` or `↓` enters it, and the row is what the user is typing |
