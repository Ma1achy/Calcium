...
19. **The budget table is measured or it is blank.** A01 Appendix B's rows are answered from a report or reported as unanswerable with what they would need; none of them is estimated, none defaults to zero, and a table with an unanswered row returns no verdict rather than a passing one. (I37)
